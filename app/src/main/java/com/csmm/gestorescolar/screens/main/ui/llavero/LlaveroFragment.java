...
import com.csmm.gestorescolar.databinding.FragmentLlaveroBinding;

public class LlaveroFragment extends Fragment {

    private FragmentLlaveroBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentLlaveroBinding.inflate(inflater, container, false);
